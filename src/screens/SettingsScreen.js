          ...
          <ScrollView contentInsetAdjustmentBehavior="automatic">
            <View style={Theme.maincontainer}>
              ...
              <Text style={Theme.text}>
                This information is needed to calculate your strength scores.
              </Text>
            </View>
            <TouchableOpacity style={Theme.maincontainer} onPress={this.flipGender}>
              <View style={Theme.rowContainer}>
                ...
                <View style={{marginLeft: 'auto'}}>
                  <Text style={{marginRight: 10}}>
                    <Icon name="ios-swap" color={Color.active} size={35} />
                  </Text>
                </View>
              </View>
            ...
            <TouchableOpacity
              ...
              <View style={Theme.rowContainer}>
                <View style={Theme.sectionContainer}>
                  ...
                  <Text style={Theme.sectionDescription}>
                    {this.state.birthday ? formatDate(this.state.birthday) : 'Not set'}
                  </Text>
                </View>
                <View style={{marginLeft: 'auto'}}>
                  <Text style={{marginRight: 10}}>
                    <Icon name="ios-calendar" color={Color.active} size={35} />
                  </Text>
                </View>
              </View>
              <View style={Theme.sectionContainer}>
                ...
                <Text style={Theme.sectionDescription}>
                  {this.state.age ? this.state.age : 'Not set'}
                </Text>
              </View>
              <Text style={Theme.text}>Touch to change</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              style={Theme.maincontainer}
              onPress={() => {
                this.setState({showWeightInput: !this.state.showWeightInput});
              }}>
              <View style={Theme.rowContainer}>
                <View style={Theme.sectionContainer}>
                  <Text style={Theme.sectionTitle}>Bodyweight: </Text>
                  <Text style={Theme.sectionDescription}>
                    {this.state.bodyweight ? this.state.bodyweight + ' kg' : 'Not set'}
                  </Text>
                </View>
                <View style={{marginLeft: 'auto'}}>
                  <Text style={{marginRight: 10}}>
                    <Icon name="ios-body" color={Color.active} size={35} />
                  </Text>
                </View>
              </View>
                ...
                <View style={Theme.rowContainer}>
                  <TextInput
                    ...
                    onChangeText={(input, eventCount, target) => {
                      this.setState({
                        bodyweight: parseInt(input, 10),
                      });
                      storeData('bodyweight', parseInt(input, 10));
                    }}
                  />
            ...
            <TouchableOpacity
              ...
              <Icon name="ios-construct" color={Color.buttonFontColor} size={16} />
